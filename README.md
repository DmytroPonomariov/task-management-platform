...
5. **Тестування:**
   - **Jest Unit Tests (Бекенд):** 21 тест для сервісів завдань та категорій ([app.service.spec.ts](file:///d:/Front-end%20engineer/newtask%20-%20Copy/apps/api/src/app/app.service.spec.ts)).
   - **Vitest Integration Tests (Фронтенд):** 6 тестів для перевірки рендерингу, пошуку, категорій, створення та видалення задач ([app.spec.tsx](file:///d:/Front-end%20engineer/newtask%20-%20Copy/web/src/app/app.spec.tsx)).
   - **api-e2e Integration Tests (Jest):** 5 наскрізних інтеграційних тестів для API ([api.spec.ts](file:///d:/Front-end%20engineer/newtask%20-%20Copy/apps/api-e2e/src/api/api.spec.ts)).
...
4. **Преміальний дизайн (Aesthetics):** Розроблено сучасний інтерфейс у стилі **glassmorphism** з темною темою за замовчуванням, плавними градієнтами, ефектами розмиття фону, hover-анімаціями та фірмовими бейджами.
